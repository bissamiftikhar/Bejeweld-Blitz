...
//    }
//    int check = 2;
//    sf::RenderWindow window(sf::VideoMode(900, 600), "chuttuuu", sf::Style::Close | sf::Style::Resize);
//
//
//    sf::Texture bg;
//    sf::Texture start;
...
//    }
//    if (check % 2 == 0) {
//        sf::RenderWindow newwindow(sf::VideoMode(600, 600), "chuttuuu", sf::Style::Close | sf::Style::Resize);
//        sf::Texture selectorTexture;
//        selectorTexture.loadFromFile("selector.png"); // Replace "selector.png" with the actual file name of your selector image
...
//                remainingTime = 0.0f; // Ensure the timer doesn't display negative values
//                // Add logic to handle game over when time is up
//            }
//
